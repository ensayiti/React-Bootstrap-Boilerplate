...
const About = () => {
    return (
        <div className="px-4 py-5 my-5 text-center">
            <img className="d-block mx-auto mb-4" src={viteSvg} alt="React" width="72" height="57" />
            ...
            <div className="col-lg-6 mx-auto">
                ...
                <p className='mb-4 fw-semibold text-bg-warning'>Please click on the Home button to check if router is works.</p>
